...
// $Id$
//
/// \file ExampleSteppingAction.hh
/// \brief Definition of the ExampleSteppingAction class

#ifndef ExampleSteppingAction_h
#define ExampleSteppingAction_h 1
...
class ExampleSteppingAction : public G4UserSteppingAction
{
  public:
    ...
    virtual ~ExampleSteppingAction();

    // static access method
    static ExampleSteppingAction* Instance();
  ...
  private:
    static ExampleSteppingAction* fgInstance;  

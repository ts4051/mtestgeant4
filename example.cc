...
// $Id$
//
/// \file exampleExample.cc
/// \brief Main program of the Example example
...
int main(int argc,char** argv)
{
  ...
  //
  // Stepping action
  runManager->SetUserAction(new ExampleSteppingAction());     

  // Event action
  runManager->SetUserAction(new ExampleEventAction());

  // Run action
  runManager->SetUserAction(new ExampleRunAction());

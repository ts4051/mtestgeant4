...
// $Id$
//
/// \file ExampleDetectorConstruction.cc
/// \brief Implementation of the ExampleDetectorConstruction class
...
*/
  ...
  //
  ExampleSteppingAction* steppingAction = ExampleSteppingAction::Instance(); 
